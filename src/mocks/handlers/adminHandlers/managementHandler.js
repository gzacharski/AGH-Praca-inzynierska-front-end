...
export const managementHandlers = [
   rest.get(`${discoveryServiceURL}/apps`, (req, res, ctx) =>
      res(
         ctx.status(200),
         ctx.delay(),
         ctx.json({
            application: [
               ...
               },
               {
                  ...
                  instance: [
                     {
                        instanceId:
                           'trainings:f57392e84c044f8698f162f6531be33c',
                        app: 'TRAININGS',
                        appGroupName: null,
                        ipAddr: '172.25.0.1',
                        sid: 'na',
                        ...
                        healthCheckUrl:
                           'http://localhost:29078/actuator/health',
                        secureHealthCheckUrl: null,
                  ...
                  instance: [
                     {
                        ...
                        healthCheckUrl:
                           'http://localhost:18004/actuator/health',
                        secureHealthCheckUrl: null,
                        vipAddress: 'task',
                  ...
                  instance: [
                     {
                        ...
                        healthCheckUrl:
                           'http://localhost:22804/actuator/health',
                        secureHealthCheckUrl: null,
                        vipAddress: 'auth',
